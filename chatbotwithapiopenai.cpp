...
ChatbotWithAPIOpenAI::ChatbotWithAPIOpenAI(VizData *vizData, QObject *parent){
    this->vizData = vizData;
    networkManager = new QNetworkAccessManager(this);
    connect(networkManager, &QNetworkAccessManager::finished, this, &ChatbotWithAPIOpenAI::handleAPIResponse);
}

void ChatbotWithAPIOpenAI::sendMessage(const QString& message) {
...
void ChatbotWithAPIOpenAI::handleAPIResponse(QNetworkReply* reply) {
...
void ChatbotWithAPIOpenAI::sendFile(const QString& filePath) {
...
void ChatbotWithAPIOpenAI::fromJS(const QString &message) {
